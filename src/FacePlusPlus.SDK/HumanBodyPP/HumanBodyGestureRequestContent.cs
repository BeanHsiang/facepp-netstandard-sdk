...
{
    class HumanBodyGestureRequestContent : HumanBodyPPRequestContent<MultipartFormDataContent>, IDisposable
    {
        public override string Name => "gesture";
        ...
        /// <summary>
        /// whether return all gestures
        /// <list type="1">yes</list>
        /// <list type="0">no</list>
        /// </summary>
        public string Return_Gesture { get; set; }
        ...
        public override void AddToMultipartContent(Dictionary<string, dynamic> content)
        {
            ...
            if (!string.IsNullOrWhiteSpace(Return_Gesture))
            {
                content.Add("return_gesture", new StringContent(Return_Gesture));
            }
