...
{
    class ImageDetectSceneAndObjectRequestContent : ImagePPRequestContent<MultipartFormDataContent>, IDisposable
    {
        public override string Name => "detectsceneandobject";
